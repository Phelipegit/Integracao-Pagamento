...
public class ActiveAccountService {
    ...
    public ActiveAccountService(UserRepository userRepository,RedisService redis) {
        this.userRepository = userRepository;
        this.redis = redis;
    }

    public ResponseEntity<ApiResponse<String>> activeAccount(String email, String uuid) {
        PendingUserData pendingUserData = redis.getAccountVerificationByKey(email);
        ...
        redis.deletePendingUserData(email);
